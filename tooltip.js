class Tooltip extends HTMLElement {
  ...
  // Method that gets executed after the element is attached to the DOM, so if you do DOM manipulations on the element itself, do it here
  connectedCallback() {
...
customElements.define("g4-tooltip", Tooltip);
